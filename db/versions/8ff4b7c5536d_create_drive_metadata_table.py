...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("lastmodifyinguser_displayname", sa.String(12)),
        sa.Column("lastmodifyinguser_kind", sa.String(10)),
        sa.Column("lastmodifyinguser_me", sa.String(5)),
        sa.Column("lastmodifyinguser_permissionid", sa.String(20)),
        sa.Column("lastmodifyinguser_emailaddress", sa.String(25)),
        sa.Column("lastmodifyinguser_photolink", sa.String(52)),
